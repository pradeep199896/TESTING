...
public class CustomerId  implements java.io.Serializable {
    ...
    public CustomerId(Integer customerId, String adbTrackingid, String DStatus, String sequenceId, String city, String firstName, String lastName, String state, String zip, Date dbtime, Blob blobc, Clob clobc, Date systemtime) {
       this.customerId = customerId;
