...
public class VwCustomerId  implements java.io.Serializable {
    ...
    public VwCustomerId(Integer customerId) {
        this.customerId = customerId;
    }
    public VwCustomerId(Integer customerId, String adbTrackingid, String DStatus, String sequenceId, String city, String firstName, String lastName, String state, String zip, Date dbtime, Blob blobc, Clob clobc, Date systemtime) {
       this.customerId = customerId;
