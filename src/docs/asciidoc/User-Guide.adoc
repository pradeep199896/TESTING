...
include::{docdir}/../sections/general/configuration/sink/database-sink-properties.adoc[leveloffset=+2]
include::{docdir}/../sections/general/configuration/source/database-source-properties.adoc[leveloffset=+2]
